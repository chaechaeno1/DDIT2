...
class DataBox {
	...
	/*
	 * value값이 null이면 value에 문자열이 채워질 때까지 기다리고 value에 값이 있으면 해당 문자열을 반환한다. (이 때, 반환
	 * 후에는 value값을 null로 만든다.)
	 * 
	 */
	...
	/*
	 * value변수에 값이 있으면 value가 null이 될 때까지 기다린다. value가 null이 되면 새로운 데이터 값을 value에
	 * 저장한다.
	 * 
	 */
	...
	public synchronized void setValue(String value) {
		...
		// this.value의 값이 null일 때 처리한 내용을 작성
		this.value = value;
