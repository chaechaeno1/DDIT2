...
public class URLTest02 {
	...
	public static void main(String[] args) throws IOException {
		// URLConnection 클래스 ==> 애플리케이션과 URL간의 통신연결을 위한 클래스
		...
		// Header정보 가져오기
		// => 구한 Map객체의 key값은 Header정보의 이름을 나타내고 value값은 Header정보의 값을 나타낸다.
		 ...
		 * 
		 * //방법1 ==> URLConnection객체를 이용하는 방법 //파일을 가져오기 위한 입력 스트림 객체 생성 InputStream in
		 * = urlCon.getInputStream(); InputStreamReader isr = new
		 * InputStreamReader(in,"utf-8"); BufferedReader br = new BufferedReader(isr);
		 * 
		 * //자료 내용을 읽어와 화면에 출력하기 while(true) { String str = br.readLine(); //한 줄씩 읽어오기
		 * if(str==null) break; System.out.println(str); } br.close();
		 */
