 ...
 * 
 * -http 				==> 프로토콜
 * -localhost 			==> 서버 컴퓨터 이름(또는 도메인명) 또는 IP주소
 * -80 					==> Port번호(80번일 경우 생략 가능)
 * -/webTest 			==> 컨텍스트 패스 (보통 웹 프로젝트 이름으로 지정
 * -/servletTest01.do 	==> 서블릿 요청 패턴
 */



//servelt클래스는 HttpServlet클래스를 상속해서 작성한다.
public class ServletTest01 extends HttpServlet {
	// 이 클래스에서는 service()메서드 또는 doGet(), doPost()메서드를 재정의해서 처리할 내용을 작성한다.
	...
	// 2) HeepServletResponse객체 ==> 서비스 응답에 관련된 정보 및 메서드를 관리하는 객체
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.append("<html>")
			...
			.append("안녕하세요, 첫번째 Servlet 프로그램 입니다...</h2>)")
			.append("</body>")
			.append("</html>");
